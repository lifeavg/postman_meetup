...
- [Useful tricks](/7_useful_tricks.md)
  - [Switching HTTP/HTTPS](/7_useful_tricks.md#switching-httphttps)
  - [Environment protection](/7_useful_tricks.md#environment-protection)
  - [Cookie change](/7_useful_tricks.md#cookie-change)
  - [Request iteration](/7_useful_tricks.md#request-iteration)
  - [HTML response parsing](/7_useful_tricks.md#html-response-parsing)
